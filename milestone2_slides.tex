...
\begin{frame}{Two-Stage Pipeline}
  ...
  \begin{itemize}\itemsep2pt
    ...
    \item Output: \texttt{two\_stage\_results\_blip.jsonl} / \texttt{two\_stage\_results\_clip\_gpt2.jsonl}.
  \end{itemize}
...
\begin{frame}{Final Results --- Takeaway}
  ...
  \begin{tabular}{lrrrrr}
    ...
    \midrule
    Two-Stage: BLIP $\rightarrow$ GPT-2 refiner   & 10.84 & 0.37 &  8.87 &  9.53 & 0.63 \\
...
% ============================================================================
%  APPENDIX --- Dataset EDA + Attention Maps
% ============================================================================

% ----- Appendix A: Dataset Overview -----------------------------------------
\begin{frame}{Appendix: Dataset Overview (EDA)}
  \begin{columns}[T]
    \begin{column}{0.50\textwidth}
      \includegraphics[width=\linewidth]{models/results/eda/category_distribution.png}
    \end{column}
    \begin{column}{0.50\textwidth}
      \includegraphics[width=\linewidth]{models/results/eda/split_sizes.png}
    \end{column}
  \end{columns}
\end{frame}

% ----- Appendix B: Description Length Distribution --------------------------
\begin{frame}{Appendix: Description Length by Category}
  \begin{columns}[T]
    \begin{column}{0.50\textwidth}
      \includegraphics[width=\linewidth]{models/results/eda/desc_word_count.png}
    \end{column}
    \begin{column}{0.50\textwidth}
      \includegraphics[width=\linewidth]{models/results/eda/desc_length_by_category.png}
    \end{column}
  \end{columns}
\end{frame}

% ----- Appendix C: Attention Maps -------------------------------------------
\begin{frame}{Appendix: BLIP Vision Encoder Attention Rollout}
  \begin{columns}[T]
    \begin{column}{0.33\textwidth}
      \includegraphics[width=\linewidth]{models/results/attention_maps/470823582_attention.png}
    \end{column}
    \begin{column}{0.33\textwidth}
      \includegraphics[width=\linewidth]{models/results/attention_maps/459890016_attention.png}
    \end{column}
    \begin{column}{0.33\textwidth}
      \includegraphics[width=\linewidth]{models/results/attention_maps/946682182_attention.png}
    \end{column}
  \end{columns}
  \vspace{4pt}
  {\footnotesize Attention rollout through all ViT-B/16 layers — warm areas = regions BLIP weights most when generating the description.}
\end{frame}
